...
// Remove calls the "remove" endpoint of the "user" service.
...
// Rate calls the "rate" endpoint of the "user" service.
func (c *Client) Rate(ctx context.Context, p map[uint32][]string) (err error) {
	_, err = c.RateEndpoint(ctx, p)
	return
}

// MultiAdd calls the "multi_add" endpoint of the "user" service.
...
// MultiUpdate calls the "multi_update" endpoint of the "user" service.
