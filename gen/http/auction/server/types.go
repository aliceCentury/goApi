...
// StoredBottleResponseCollection is the type of the "auction" service "pick"
// endpoint HTTP response body.
type StoredBottleResponseCollection []*StoredBottleResponse

// StoredBottleResponseTinyCollection is the type of the "auction" service
...
// result of the "pick" endpoint of the "auction" service.
func NewStoredBottleResponseCollection(res auctionviews.StoredBottleCollectionView) StoredBottleResponseCollection {
	...
	for i, val := range res {
		...
		if val.Winery != nil {
			body[i].Winery = marshalAuctionviewsWineryViewToWineryResponseTiny(val.Winery)
		}
		if val.Composition != nil {
			body[i].Composition = make([]*ComponentResponse, len(val.Composition))
			for j, val := range val.Composition {
				body[i].Composition[j] = marshalAuctionviewsComponentViewToComponentResponse(val)
			}
		}
	}
	return body
...
// result of the "get" endpoint of the "auction" service.
func NewStoredBottleResponseTinyCollection(res auctionviews.StoredBottleCollectionView) StoredBottleResponseTinyCollection {
...
// of the "pick" endpoint of the "auction" service.
func NewPickNoCriteriaResponseBody(res auction.NoCriteria) PickNoCriteriaResponseBody {
...
func NewPickNoMatchResponseBody(res auction.NoMatch) PickNoMatchResponseBody {
	body := PickNoMatchResponseBody(res)
	return body
}

// NewPickCriteria builds a auction service pick endpoint payload.
func NewPickCriteria(body *PickRequestBody) *auction.Criteria {
	v := &auction.Criteria{
		Name:   body.Name,
		Winery: body.Winery,
	}
